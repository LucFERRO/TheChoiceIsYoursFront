        ...
        <div className='container'>
            ...
            <form className='formRegister' onSubmit={submit} method="post">
                <div className={inputStyle.styledForm}>
                    ...
                    <>
                        <div className={inputStyle.inputContainer}>
                            <textarea id="biographyInput" className={inputStyle.registerInput} onBlur={handleLabel} onChange={handleInputChange} name="biography" value={dataForm.biography} type="text" placeholder=""/>
                            <label htmlFor="biographyInput" id="biographyInputLabel">Biography</label>
                        </div>
                    </> 
                        : ''
                    }
